    ...
    return (
        ...
        className="stats">
            ...
            <div className="stats-right">
                    <img alt="" className="bmo" width="140px" height="50px" src={bmo}/>
    ...
    return (
        ...
        className="stats">
            <div className="stats-left ">
                <img
                alt="" className={statInfoStyle}  src={playButton}/>
                <span className="stats-info bigstat">Total Volume: </span>
            </div>
            <div className="stats-right ">
                    <img alt="" className="bmo" width="140px" height="50px" src={bmo}/>
    ...
    return (
        ...
        className="stats">
            <div className="stats-left ">
                <img 
                alt="" className={statInfoStyle}  src={playButton}/>
                <span className="stats-info bigstat"># of Holders: </span>
            </div>
            <div className="stats-right">
                    <img alt="" className="bmo" width="140px" height="50px" src={bmo}/>
    ...
    return (
        ...
        className="stats">
            <div className="stats-left ">
                <img
                alt="" className={statInfoStyle}  src={playButton}/>
                <span className="stats-info bigstat">Holder Ratio: </span>
            </div>
            <div className="stats-right">
                    <img alt="" className="bmo" width="140px" height="50px" src={bmo}/>
    ...
    return (
        ...
        onMouseLeave={() => setStatInfoStyle("bigPlayButtonFalse")} className="stats">
            <div className="stats-left ">
                ...
                alt="" className={statInfoStyle}  src={playButton}/>
                <span className="stats-info bigstat">Royalty Fee: </span>
            </div>
            <div className="stats-right">
                    <img alt="" className="bmo" width="140px" height="50px" src={bmo}/>
...
export function FloorPriceModule(props) {
    ...
    return (
        ...
        <div className="stats-left ">
        <img alt="" className={statInfoStyle}  src={playButton}/>
            <span className="stats-info bigstat">Floor Price:</span>
        </div>
